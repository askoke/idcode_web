...
// born in that day
    ...
    // output and idcode validato

    const resultInfo = {
        idcode: idcode,
        day_val: dayVal,
        month_string: monthString,
        new_year_val: newYearVal,
        birthday_val: birthDateVal,
        regisrty_string: regisrtyString,
        regisrty_val: regisrtyVal,
        born_string: bornString,
        born_val: bornVal,
        control_string: controlString,
        is_gender: isGender(idcode)
    }
    return resultInfo
}
